...
import sys
import os
sys.path.append(os.path.abspath(os.path.join(os.path.dirname(__file__), '..', 'Day1_TRANING')))
...
if __name__ == "__main__":
    ...
    question = ("Read notice.html and Hostel Student, all three courses, including laboratory charges.")
    print("Q:", question)
